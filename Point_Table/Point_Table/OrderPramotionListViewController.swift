...
class OrderPramotionListViewController: UIViewController {
    ...
    @IBOutlet weak var txtPramotion: SkyFloatingLabelTextField!
    ...
    func SetupUI() -> Void {
        ...
        lblOr.font = UIFont(name: Font_Semibold, size: 16)


        txtPramotion.font = UIFont(name: Font_Regular, size: 17)
...
extension OrderPramotionListViewController :UITableViewDataSource {
...
extension OrderPramotionListViewController :UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        return isOrderPramotion ? UITableView.automaticDimension : 140
    }
